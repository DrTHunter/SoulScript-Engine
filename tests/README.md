...
| `test_burst.py` | 55 | Burst runner types, tick execution, prompt assembly, structured output parsing, tool dispatch, memory flush, PII guard |
...
**Total: 566 checks across 7 suites**
...
python -m tests.test_tools; python -m tests.test_memory; python -m tests.test_directives; python -m tests.test_burst; python -m tests.test_boundary; python -m tests.test_governance; python -m tests.test_routing
```
