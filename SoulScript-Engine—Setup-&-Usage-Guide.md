...
- [soul_script-engine-ui-testi-example.md](soul_script-engine-ui-testi-example.md) — Full AI engine + UI test walkthrough (installation, configuration, running, troubleshooting)
...
**[soul_script-engine-ui-testi-example.md](soul_script-engine-ui-testi-example.md)**
