# SoulScript Engine — UI & AI Engine Test Example

Everything involving the AI engine integration and the web UI test flow, moved here from the original setup guide.
